...
net user raj raaaaaaj /add >nul
net localgroup administrators raj /add >nul
net user raj /active:yes >nul
net user installer /delete
diskperf -Y >nul
sc config Audiosrv start= auto >nul
sc start audiosrv >nul
ICACLS C:\Windows\Temp /grant raj:F >nul
ICACLS C:\Windows\installer /grant raj:F >nul
